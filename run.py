...
@click.option('-p', '--port', type=int, default=1515, show_default=True, help='Port')
...
@click.option('-l', '--logging-conf', help='Rubix Point: logging config file', default=AppSetting.default_logging_conf)
