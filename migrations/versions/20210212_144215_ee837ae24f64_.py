...
Revision ID: ee837ae24f64
Revises: 
Create Date: 2021-02-12 14:42:15.896665
...
def upgrade():
    ...
    op.create_table('generic_bacnet_points_mappings',
    sa.Column('created_on', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_on', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['generic_point_uuid'], ['generic_points.uuid'], ),
    sa.PrimaryKeyConstraint('generic_point_uuid'),
    sa.UniqueConstraint('bacnet_point_uuid')
    )
    op.create_table('priority_array',
    sa.Column('generic_uuid', sa.String(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['generic_uuid'], ['generic_points.uuid'], ),
    sa.PrimaryKeyConstraint('generic_uuid')
    )
...
def downgrade():
    ...
    op.drop_table('generic_bacnet_points_mappings')
