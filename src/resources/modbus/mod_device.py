...
from src.interfaces.modbus.device.interface_modbus_device import interface_name, interface_ip, interface_port, attributes, THIS
...
class ModDevice(Resource):
    ...
    def create_device_model_obj(mod_device_uuid, data):
        return ModbusDeviceModel(mod_device_uuid=mod_device_uuid, mod_device_name=data['mod_device_name'], mod_device_ip=data['mod_device_ip'], mod_device_port=data['mod_device_port'])
