...
# from src.sourceDrivers.modbusCopy.models.mod_point_store import ModbusPointStoreModel
...
class TcpPolling:
    ...
    def polling(self):
        ...
        while True:
            ...
            results = db.session.query(ModbusNetworkModel, ModbusDeviceModel, ModbusPointModel).all()
    ...
    def poll_point(self, device, point):
        ...
        try:
            ...
            # ModbusPointStoreModel(mod_point_value=val, point_uuid=point.point_uuid).save_to_db()
