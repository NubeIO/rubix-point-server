...
from src.sourceDrivers.modbus.interfaces.point.interface_modbus_point import points_attributes, THIS, interface_name, interface_reg, \
...
class ModPointListAOs(Resource):
    @marshal_with(fields, envelope="mod_points")
    def get(self):
        return ModbusPointModel.query.all()
